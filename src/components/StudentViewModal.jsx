        ...
        <div className="pt-6 border-t border-gray-200">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="bg-green-50 p-4 rounded-lg border border-green-200 text-center">
              <p className="text-xs text-green-600 mb-1 uppercase tracking-wide">
                Paid
              </p>
            ...
            <div className="bg-red-50 p-4 rounded-lg border border-red-200 text-center">
              <p className="text-xs text-red-600 mb-1 uppercase tracking-wide">
                Pending
              </p>
          ...
          <div className="pt-6 border-t border-gray-200">
            <h3 className="text-sm font-semibold text-gray-700 uppercase tracking-wide mb-3 flex items-center justify-between">
              ...
              <span className="text-xs bg-blue-100 text-blue-700 px-2 py-1 rounded-full">
                {semesterFeesWithStatus.filter((s) => s.paid).length} /{" "}
                {semesterFeesWithStatus.length} Paid
              </span>
            </h3>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500">
                          Due:{" "}
                          {new Date(semFee.dueDate).toLocaleDateString(
                            "en-IN",
                            {
                              year: "numeric",
                              month: "short",
                        ...
                        {semFee.paidAmount > 0 && !semFee.paid && (
                          <p className="text-xs text-amber-600 font-medium mt-1">
                            Partial: {formatCurrency(semFee.paidAmount)} paid,{" "}
                            {formatCurrency(semFee.remainingAmount)} remaining
                          </p>
                        )}
                      </div>
                    </div>
