...
import { Plus, Trash2, Search, X, BookOpen, GraduationCap, DollarSign, Loader2, MoreVertical, Eye, Edit, Info, Clock, Users } from "lucide-react";
...
const Courses = () => {
  ...
  const handleChange = (e) => {
    ...
    if (name === "semesterFees" || name === "totalSemesters") {
      const semesterFees = name === "semesterFees" ? parseFloat(value) || 0 : parseFloat(formData.semesterFees) || 0;
      const totalSemesters = name === "totalSemesters" ? parseInt(value) || 0 : parseInt(formData.totalSemesters) || 0;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (selectedCourse) {
        ...
        updatedCourses = courses.map((c) => (c.id === selectedCourse.id ? courseData : c));
      } else {
        // Add new course
  ...
  if (loading) {
    return (
     <LoadingSpinner message="Getting Courses data"/>
    );
  }
    ...
    actionButton={
          ...
          {success && (
            <div className="mb-6 p-4 bg-green-50 border-l-4 border-green-500 text-green-700 rounded-lg flex items-center">
              ...
              <span className="text-sm font-medium">Course saved successfully!</span>
            </div>
          )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredCourses.length > 0 ? (
                ...
                >
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600 mb-2">{course.degreeType}</p>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="font-semibold text-gray-900">{course.totalSemesters}</span>
                    </div>
                    <div className="flex items-center justify-between text-sm">
                      <span className="text-gray-600 flex items-center gap-1">
                      ...
                      <span className="font-semibold text-gray-900">{formatCurrency(course.semesterFees)}</span>
                    </div>
                    <div className="pt-3 border-t border-gray-200">
                      <div className="flex items-center justify-between">
                        <span className="text-gray-700 font-medium">Total Fees:</span>
                        <span className="text-lg font-bold text-gray-900">{formatCurrency(course.totalFees)}</span>
                      </div>
                    </div>
                    {course.description && (
              ...
              <div className="col-span-full text-center py-16">
                ...
                <p className="text-gray-500 text-sm">Try adjusting your filters or add a new course</p>
              </div>
            )}
          </div>
                ...
                <div className="sticky top-0 bg-gray-800 text-white p-6 rounded-t-lg flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300 text-sm">Fill in the course information below</p>
                    </div>
                  </div>
                  <button
                    onClick={handleCloseModal}
                ...
                <form onSubmit={handleSubmit} className="p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="md:col-span-2">
                      ...
                      <p className="text-xs text-gray-500 mt-1">Auto-calculated: Fee per Semester × Total Semesters</p>
                    </div>
                  ...
                  <div className="space-y-6">
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-lg font-semibold text-gray-900">{selectedCourse.degreeType}</p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-600 mb-1">Department</p>
                        <p className="text-lg font-semibold text-gray-900">{selectedCourse.department}</p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-600 mb-1">Duration</p>
                        <p className="text-lg font-semibold text-gray-900">{selectedCourse.duration}</p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-600 mb-1">Total Semesters</p>
                        <p className="text-lg font-semibold text-gray-900">{selectedCourse.totalSemesters}</p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-600 mb-1">Fee per Semester</p>
                        <p className="text-lg font-semibold text-gray-900">{formatCurrency(selectedCourse.semesterFees)}</p>
                      </div>
                      <div className="col-span-2">
                        <p className="text-sm text-gray-600 mb-1">Total Course Fees</p>
                        <p className="text-2xl font-bold text-gray-900">{formatCurrency(selectedCourse.totalFees)}</p>
                      </div>
